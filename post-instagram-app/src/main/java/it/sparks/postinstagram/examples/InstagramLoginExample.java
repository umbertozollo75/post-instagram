...
public class InstagramLoginExample {
    ...
    public static void main(String[] args) throws Exception {
        String USERNAME = "umbertozollo";
        String PASSWORD = "Shimano#1975#";
     ...
     * @throws Exception
     */
    public static void checkInstagramLoginResult(Instagram4j instagram4j, InstagramLoginResult instagramLoginResult, boolean doReAuthentication) throws Exception {
